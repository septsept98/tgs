        ...
        if(empty($_SESSION["nm_user"])){
            ...
            $id=$_GET['id'];
            $data = $conn->prepare("SELECT * FROM dosen WHERE kd_dosen='$id'");
            $data->execute();
            $row = $data->fetch();
        ?>
        <div class="content">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Update</strong> Dosen
                            </div>
                            <form action="fungsi/f_update.php<?php echo '?kd_dosen='.$id; ?>" method="POST" enctype="multipart/form-data" class="form-kegiatan">
                                ...
                                <div class="card-body card-block">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="nm_dosen" name="nm_dosen" value="<?php echo $row['nm_dosen']; ?>" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
